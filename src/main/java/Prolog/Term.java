...
public abstract class Term extends PlPattern {
    ...
    public abstract List<UnificationClause> unify(Term other, Unifier env) throws UnificationFailureException;

    public String getName() {return name;}


    static Pattern compound = Pattern.compile("([a-z]+)\\(((?:[a-zA-Z]+,?)+)\\)");
